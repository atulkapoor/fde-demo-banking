...
# chain this module.
"""provisioning: terraform-module, via plain-python.

Declarative provisioning: provisioning_api == true
...
class Provisioning:
    """Guard, as terraform-module."""

    interface = "Guard"
    approach = "terraform-module"
    stack = "plain-python"
    ...
    # arise.
    provides_teardown = "terraform-module" == "terraform-module"
